...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_file', default='P_ROM_', type=str, help='File name for saved results')

    # Network structure
    parser.add_argument('--r', type=int, default=50, help='Dimension of space to learn ROM')
    parser.add_argument('--input_dense_layer_sizes', type=int, nargs='+', default=[100], help='Pre-LSTM dense layers')
    parser.add_argument('--lstm_size', default=[100,100], type=int, help='Units in LSTM layer')
    parser.add_argument('--output_dense_layer_sizes', type=int, nargs='+', default=[100,50], help='Post-LSTM dense layers')
