...
def main(args):
    ...
    starting_times_POD = np.linspace(870.25,1020-tau-1,n_samp)
    ...
    for j in tqdm(range(n_samp)):
        ...
        for r in ranks:
            ...
            start_time = timer()
            uv_r = mean_flow + np.multiply(Phi[:,:r], Sigma[:r]) @ Psi[starting_inds_POD[j],:r].reshape(r,1)
...
if __name__ == "__main__":
    ...
    # POD rank
    parser.add_argument('--ranks', type=float, nargs='+', default=[32, 64, 128, 256])
