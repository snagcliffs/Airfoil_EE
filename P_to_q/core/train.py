...
from P_to_EE_generator import P_to_EE_generator
...
def main(args):
    ...
    ##
    gen = P_to_EE_generator(args.data_path, 
                             args.tau, 
                             m_hist = args.m_hist, 
                             stride = args.stride,  
    ...
    for trial in range(args.n_restarts):
        ...
        Models.append(P_to_EE_net(data_params,net_params,learning_params))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--lstm_size', default=[32,32], type=int, help='Units in LSTM layer')
    ...
    # NN input parameters
    parser.add_argument('--m_hist', default=140, type=int, help='Number of history points to use in training')
    ...
    parser.add_argument('--l2_reg', default=1e-3, type=float, help='L2 penalty on NN weights')
    parser.add_argument('--n_restarts', default=3, type=int, help='Number of restarts.')
    parser.add_argument('--epochs', default=1000, type=int, help='Number of epochs.')
    parser.add_argument('--batch_size', default=1000, type=int, help='Batch size')
    parser.add_argument('--patience', default=10, type=int, help='Optimization patience.')
    parser.add_argument('--contiguous_sets', default='test', type=str, help='Data partition.')
