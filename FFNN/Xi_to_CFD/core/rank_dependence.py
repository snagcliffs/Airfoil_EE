...
def build_model_and_gen(datapath, ranks):
    ...
    ##
    models = [pressure_encoder(restart_file = '../../P_to_Xi/saved_models/FFNN_'+str(rank)+'.npy') for rank in ranks]
...
def main(args):
    ...
    models, gen = build_model_and_gen(datapath, ranks)
