...
if __name__ == "__main__":
    ...
    parser.add_argument('--l1_reg', default=1e-2, type=int, help='L1 penalty on NN weights')
    parser.add_argument('--l2_reg', default=1e-2, type=int, help='L2 penalty on NN weights')
